...
function Counpon() {
    ...
    const CouponCard = ({ coupons }) => (
        <div className="w-full bg-gray-100 p-4 rounded-lg">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden flex flex-col sm:flex-row">
                ...
                <div className="bg-red-600 flex items-center justify-center px-4 py-6 relative sm:min-w-[80px] w-full sm:w-auto">
                    <div className="text-white text-center">
                        <div className="text-2xl sm:text-2xl lg:text-3xl font-bold leading-tight">
                            {coupons.discount} %
                        </div>
                    </div>
                    {/* Red border accent */}
                ...
                <div className="flex-1 p-4">
                    ...
                    <div className="flex justify-end mt-3">
                        <button
                            ...
                            className="bg-gray-900 text-white px-4 py-1.5 rounded-md text-sm font-medium hover:bg-gray-800 transition-colors duration-200 w-full sm:w-auto"
                        >
                            Sao chép mã
                        </button>
                    </div>
    ...
    return (
        <div className="w-[90%] mx-auto p-4">
            ...
            {/* Responsive grid: 1 column mobile, 2 on small, 2 on tablet (md), 3 on desktop (lg), 4 on xl */}
